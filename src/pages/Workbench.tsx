...
export function Workbench({ categories, setCategories, profile }: any) {
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={
        <div className="p-4 space-y-2 pb-8 pt-12">
      {/* Header */}
      <motion.div 
...
function SubPageLayout({ title, onBack, children, noPadding = false }: { title: React.ReactNode, onBack: () => void, children: React.ReactNode, noPadding?: boolean }) {
  return (
